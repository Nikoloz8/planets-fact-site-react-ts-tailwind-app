...
export default function Tailwind() {
    ...
    const buttonStyle = `w-[100%]! hover:bg-[rgba(216,216,216,0.2)]! h-[48px]! flex gap-[20px] items-center justify-start p-[0_20px_0_20px]! bg-transparent border-solid border-[1px] border-[rgba(255,255,255,0.2)] text-left ${H3}`
